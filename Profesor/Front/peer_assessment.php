    ...
    $(document).ready(function() {
        ...
        $("#crear_nueva_evaluacion").click(function(){
            ...
            $.ajax({
                ...
                else if(h.exito=="equipo_incompleto"){
                    alert("La evaluación no pudo ser creada debido a que algún equipo tiene menos de 2 estudiantes.");
                    $('#myModal').modal('hide');
                }
                else if(h.exito=="equipo_vacio"){
                    alert("No hay ningún equipo creado. No se puede asignar evaluaciones sin equipos.");
                    $('#myModal').modal('hide');
                }
                else{
